...
2. **Tutor Page (/tutor):**
   ...
   - Add a new Bio field (textarea).
   - Replace the 'subject' field with a dropdown of predefined subjects: Physics, Chemistry, Biology, Maths, English, French, Arabic, Social Sciences.

3. **Student Page (/student):** Modified to display the new subjects and bio.
